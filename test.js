...
update_actions = async () => {
    dataupdate = {
        ...
        uid: '3045',
        type: null,
        product_link: 'https://shopee.vn/Heo-kh%C3%B4-ch%C3%A1y-t%E1%BB%8Fi-dai-m%E1%BB%81m-HUHO-FOOD-DA23-i.867050383.15292984669',
        product_name: 'Heo-khô-cháy-tỏi-dai-mềm-HUHO-FOOD-DA23',
        product_id: '15292984669',
        product_image: 'sg-11134201-22120-2weu1cvlfflvb7',
        product_sku: 'DA23',
        shop_id: '867050383',
        keyword: 'heo khô cháy tỏi',
        keyword_search: null,
        max_page: '0',
        actions: null,
        click_product: null,
        accounts: null,
        time_day: '2022-12-23 00:00:00',
        total_product_search: '1',
        total_product_order: '1',
        total_product_view_product: '1',
        total_product_add_cart: '1',
        total_product_view_review: '1',
        total_product_view_shop: '1',
        total_product_heart_product: '1',
        total_product_follow_shop: '1',
        product_point: '0',
        all_request: '0',
        check_index: '0',
        product_traffic: '1',
        product_traffic_hien_tai: '1',
        product_slug: null,
        product_code: null,
        status: '1',
        product_page: null,
        product_index: null,
        update_time: '2022-12-23 03:30:09',
        created: '2022-09-27 11:28:22',
        options: '{"add_cart":1,"order":1,"view_shop":1,"view_review":1,"heart_product":1,"follow_shop":1}',
        username: 'gxxanguyendon',
        password: 'Dcdmzaqmwxe',
        clone_id: '143471',
        shopee_point: {
          heart_product: '15',
          follow_shop: '30',
        ...
        cookie: [
          {
            name: 'SPC_T_ID',
            value: '2ajBjFJLVh8Ybzg1LwTibT4YPib9/+M6tvnEoYGkMDZf8eMCMOv/O1h9Y1eXEJE8x98SBcxBwgonNIv7tDq88YSKb49elMGkM4GpQT2q1w2BG3yJj5R9Sm01Pkw5S7/QTn9pdFJXMa5aaZOpZTXZvNs+Sh8eaGmcmPjCE6xW1AE=',
            domain: '.shopee.vn',
            path: '/',
            expires: 1706420301.657835,
            size: 180,
            httpOnly: true,
            secure: true,
            session: false,
          ...
          {
            name: 'SPC_R_T_IV',
            value: 'TkxiWGR1UTNjdnBOaG5ydQ==',
            domain: '.shopee.vn',
            path: '/',
            expires: 1706420301.657803,
            size: 34,
            httpOnly: false,
            secure: true,
            session: false,
          ...
          {
            name: 'ds',
            value: '595e1f81941ca9832666aa2f8625cfe2',
            domain: 'shopee.vn',
            path: '/',
            expires: 1671891836,
            size: 34,
          ...
          {
            name: '_ga',
            value: 'GA1.1.1222055577.1671860251',
            domain: '.shopee.vn',
            path: '/',
            expires: 1706420300.440055,
            size: 30,
            httpOnly: false,
            secure: false,
            session: false,
          ...
          {
            name: 'SPC_EC',
            value: 'dUY0S3dubGE5VDQySXljcEv6oHR35LX7p7g9KF/e9V4qYSrnv/7hVtIy2dMh92Zse0ZZcHABnldnXFDcxEpVyeAeahxcfpBIgUUw8HfWlYygFWuExUsZse7CX6f7IZCxDqwIYg/u1ejwc+yLFzNhDkhCfPkOowrGFrZf+v72r3o=',
            domain: '.shopee.vn',
            path: '/',
            expires: 1706420301.657731,
            size: 178,
            httpOnly: true,
            secure: true,
            session: false,
          ...
          {
            name: 'AC_CERT_D',
            value: 'U2FsdGVkX19MNwO6gdV9LfDkQvz5rZrnNCELOCmfBbfKtuPGqbpiJLmgStZRM2jG/DTaVDK8Ja+K0a06qtbWR+oqRZyyIbBM5eWewSUdrVymFLdzDj11XpGh/NkBm9en8HVSGb47KDehHXUyvE0d/qNQSGI0ES7nGowsDm6yh34aFVsogC86tVQRsRSBZuJccnt24Jimi4V9qlfxkxWF1bwAkv7DooVgX74Pzf5yAOA=',
            domain: 'shopee.vn',
            path: '/',
            expires: 1671871069.159076,
            size: 245,
            httpOnly: false,
            secure: true,
            session: false,
          ...
          {
            name: '_gid',
            value: 'GA1.2.119298845.1671860252',
            domain: '.shopee.vn',
            path: '/',
            expires: 1671946700,
            size: 30,
          ...
          },
          {
            ...
            value: 'eyJpZCI6IjkyNTYxYjc1LTBlZDQtNDZkYS1iMmE2LWUwY2UwOGRlMTc2ZCIsImNyZWF0ZWQiOjE2NzE4NjAyNTE2MjcsImluU2FtcGxlIjpmYWxzZX0=',
            domain: '.shopee.vn',
            path: '/',
            expires: 1671862098,
            size: 133,
          ...
          {
            name: 'SPC_EC',
            value: 'o21t2QNLTxTIvDiPjATqfu5y/dtkvnPe0sp6davwnrTBTnAqy99F7Mz4AiwVivT+vwsZS/yxL1Z95WsoJCae9OrofYNdCxvdxcQrA0f/hItQG0YKY2ZSwWyeixBuRzR3UiP55JsIgblOnIrKJojcqR9NaoEZKEoLmTvBZOLHkLo=',
            domain: 'shopee.vn',
            path: '/',
            expires: -1,
            size: 178,
          ...
          {
            name: '_QPWSDCXHZQA',
            value: '2276c4b9-abc3-4a18-8569-f4cb25d93aff',
            domain: 'shopee.vn',
            path: '/',
            expires: -1,
            size: 48,
          ...
          {
            name: '_gcl_au',
            value: '1.1.1797909463.1671860248',
            domain: '.shopee.vn',
            path: '/',
            expires: 1679636247,
            size: 32,
          ...
          {
            name: 'SC_DFP',
            value: 'aWrXskdePkFDxdXrmpUuhobXWqnokCYG',
            domain: 'shopee.vn',
            path: '/',
            expires: -1,
            size: 38,
          ...
          {
            name: '_fbp',
            value: 'fb.1.1671860249484.980925396',
            domain: '.shopee.vn',
            path: '/',
            expires: 1679636300,
            size: 32,
          ...
          {
            name: 'SPC_F',
            value: 'xqtA98HfjA899weeIIVClCAwibkX9i44',
            domain: 'shopee.vn',
            path: '/',
            expires: -1,
            size: 37,
          ...
          {
            name: 'SPC_R_T_ID',
            value: 'sqypyeay7kSJPEQGP10KW2FdNAz8zt1awa2ydKllQ6lh0Vd83kePnaMHATY/JGeDZ7ifruRrs9p/lPvLMmQ8qwmvg7wu0nsDuVfniywpeA/PYm/d+VaNN7d97qvLsPbcHFWEl9Ct2MriikksOUD89pKIqMcIe0jIPvqYrQaS2dQ=',
            domain: 'shopee.vn',
            path: '/',
            expires: -1,
            size: 182,
          ...
          {
            name: 'SPC_STK',
            value: 'OLu88T/Zzc2GqG+6T1/QxPrOY0w316SjTkjAYwT4H4E9ZniFzOJZ29YA33VFshKUNYedZFRpUh2YpFRq0FaVMi5oizj8RKYW2tYvRPPQ/OSUriO+VN176mh4VT1YIpWG0RJcoJVkRlvlhinf5awhRCLO2ZJhpz5VSqDo1V4tzacAYcOZfO6eKODKmOmUz93T',
            domain: 'shopee.vn',
            path: '/',
            expires: -1,
            size: 199,
          ...
          {
            name: 'SPC_SC_TK',
            value: 'bae1a1ea61c85e0533a95b1a1bb69d00',
            domain: 'shopee.vn',
            path: '/',
            expires: -1,
            size: 41,
          ...
          },
          {
            ...
            value: 'kjIudwNKL2X3Bl51JEo%2B3Q%3D%3D%7CGBcWomwB6vY99cESYM9a9ESJW2cq3TtR%2Be%2Bv1NKENRtMWpZ5l5vz4V8yfC%2FOwSsZx0QI5HLw6LUD6NGgG5vK66%2ByM9wDh88gUg%3D%3D%7C67dT6oTVeuueSfQj%7C06%7C3',
            domain: 'shopee.vn',
            path: '/',
            expires: 1671891836,
            size: 193,
          ...
          {
            name: 'SPC_ST',
            value: '.bTh1ZklZd0hiQVlWbDZRb5UW8DFGEVIlKNy7BCkpeNB8HhmQgbXSY3coER2S1I9SwGUWWbtvCR8XpXX0VUppHi91kTCB2DwD9fW7VFcZ+7nLTLGfxw+un+yH/hiUD7lQ4d8W6k+zOs2ShR5Ro8RD7R4yGg8IMcxtUtY8AGIUcHTe4UXq2+Kt+aQik7aDWdVRkZ5RwQ2FH0/8roJoAtyi9A==',
            domain: 'shopee.vn',
            path: '/',
            expires: -1,
            size: 223,
          ...
          {
            name: '_ga_M32T05RVZT',
            value: 'GS1.1.1671860250.1.1.1671860300.10.0.0',
            domain: '.shopee.vn',
            path: '/',
            expires: 1706420300.439456,
            size: 52,
            httpOnly: false,
            secure: false,
            session: false,
          ...
          {
            name: 'csrftoken',
            value: 'GeL5LAFsLKFHes0Q5pXnosLLJO8T7Pse',
            domain: 'shopee.vn',
            path: '/',
            expires: -1,
            size: 41,
          ...
          {
            name: 'REC_T_ID',
            value: 'beb48abd-80f9-11ed-94c7-9440c93e1528',
            domain: 'shopee.vn',
            path: '/',
            expires: -1,
            size: 44,
          ...
          {
            name: 'SPC_SI',
            value: 'ypmZYwAAAAByNHN1Yjg0bdmrcwAAAAAAVmthcFF4OHU=',
            domain: '.shopee.vn',
            path: '/',
            expires: 1671946701.657616,
            size: 50,
            httpOnly: true,
            secure: true,
            session: false,
          ...
          },
          {
            ...
            value: 'eyJpZCI6IjgxZWUxMjUyLWI2ODAtNTE4Yy1iOTllLTY3YmJlNjc3NDhkMSIsImNyZWF0ZWQiOjE2NzE4NjAyNTE1NTcsImV4aXN0aW5nIjp0cnVlfQ==',
            domain: '.shopee.vn',
            path: '/',
            expires: 1703396298,
            size: 137,
        ...
        trang: 0,
        vitri: 0,
        urlSearch: 'https://shopee.vn/search?keyword=heo%20kh%C3%B4%20ch%C3%A1y%20t%E1%BB%8Fi',
        liked: false,
        action: 'search'
      }
    ...
    axios.get('https://beta.hotaso.vn/api_user/updateActions', {
        params: {
            data: {
